...
| service\_account\_primary\_cluster\_email | The service account applied to the primary compute instances which will receive traffic from the external network. | `string` | n/a | yes |
