...
5. Create a local `terraform.auto.tfvars` file and instantiate the required inputs as in the respective `./examples/standalone-airgap/variables.tf` including the path to the license under the `license_file` variable value.
